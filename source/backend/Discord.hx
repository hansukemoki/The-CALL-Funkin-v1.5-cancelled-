...
class DiscordClient
{
	...
	private inline static final _defaultID:String = "1403643117932122213";
	...
	public static function changePresence(details:String = 'The CALL Funkin', ?state:String, ?smallImageKey:String, ?hasStartTimestamp:Bool, ?endTimestamp:Float, largeImageKey:String = 'icon')
	{
		...
		presence.largeImageText = "The CALL Funkin: " + states.MainMenuState.hhdVersion;
